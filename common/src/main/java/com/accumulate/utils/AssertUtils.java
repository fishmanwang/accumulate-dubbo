...
public abstract class AssertUtils {
    ...
    /**
     * Assert that a collection has elements; that is, it must not be <code>null</code> and must
    ...
    /**
     * Assert that a Map has entries; that is, it must not be <code>null</code> and must have at
     * least one entry.
     * 
     * <pre class="code">
    ...
    /**
     * Assert a boolean expression, throwing <code>IllegalStateException</code> if the test result
     * is <code>false</code>. Call isTrue if you wish to throw IllegalArgumentException on an
     * assertion failure.
     * 
     * <pre class="code">
